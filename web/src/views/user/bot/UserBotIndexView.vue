                    ...
                    <div class="modal fade" id="add-bot" tabindex="-1">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <h5 class="modal-title" id="add-bot-title">创建Bot</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="name" class="form-name">名字</label>
                                        <input v-model="botadd.name" type="text" class="form-control" id="name" placeholder="为你的Bot起一个名字吧">
                                      </div>
                                      <div class="mb-3">
                                        <label for="description" class="form-label">简介</label>
                                        <textarea v-model="botadd.description" class="form-control" id="description" rows="3"></textarea>
                                      </div>
                                      <div class="mb-3">
                                        <label for="editor" class="form-label">代码</label>
                                        <VAceEditor
                                        ...
                                        <button type="button" class="btn btn-secondary" style="margin-right:10px" data-bs-toggle="modal" :data-bs-target="'#update-bot-'+bot.id">修改</button>
                                            ...
                                            <div class="modal fade" :id="'update-bot-'+bot.id" tabindex="-1">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        <h5 class="modal-title" id="update-bot-title">修改Bot</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label for="name" class="form-name">名字</label>
                                                                <input v-model="bot.name" type="text" class="form-control" id="name" placeholder="为你的Bot起一个名字吧">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="description" class="form-label">简介</label>
                                                                <textarea v-model="bot.description" class="form-control" id="description" rows="3" placeholder="这个用户很懒，什么也没留下~"></textarea>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="editor" class="form-label">代码</label>
                                                                <VAceEditor
            ...
            $.ajax({
                ...
                success(resp){
                    if(resp.result==="success"){
                        ...
                        botadd.error_message=resp.result;  
                    }
                }
            })
        }
